...
HD_PWD='C:/Users/sungyeong/Desktop/class_experiments_v19/class_experiments_v19.runs/soc_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_axi_gpio_1_0.tcl
