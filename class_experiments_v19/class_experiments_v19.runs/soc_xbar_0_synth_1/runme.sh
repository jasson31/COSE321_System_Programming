...
HD_PWD='C:/Users/sungyeong/Desktop/class_experiments_v19/class_experiments_v19.runs/soc_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_xbar_0.tcl
